...
public class ShelterControllerIT {
    ...
    @Test
    public void shouldAcceptProposal() throws Exception {
        //given
        given(acceptingProposal.acceptProposal(any())).willReturn(Try.success(Result.Success));
        var requestBody = "{ \"proposalId\": \"8a52a221-b769-443e-a6a1-8ba29ae76b0a\" }";
    ...
    @Test
    public void shouldCancelProposal() throws Exception {
        //given
